import torch
from pipeline.ip_pipeline import AudioLDM2Pipeline
import os
import scipy
...
freq_pooling = 4
# output folder
dir = "style-transfer-piano-32000"
num_files = 5
# audio_promt_file = "/data/fundwotsai/DreamSound/DreamSound/training_audio/output_slice_0.wav" ##IP
# audio_promt_file = "/home/fundwotsai/DreamSound/audioset/seg_audio/cutvalid_z8Wjdss5uMg_Reverberation, Music, Piano, Inside, small room.wav" ##IP
audio_promt_file= "/data/fundwotsai/DreamSound/DreamSound/piano/piano_slice_3.wav"
audio_promt_file2 = None
# audio_promt_file2 = "/data/fundwotsai/DreamSound/DreamSound/training_audio_v2/output_slice_17.wav"
ip_ckpt = "/data/fundwotsai/DreamSound/DreamSound/checkpoint-32000/pytorch_model.bin"
...
# prompt_for_trained = [["a recording of a piano solo"],
#                       ["a recording of a organ solo"],
#                       ["a recording of a acoustic guitar solo"],
#                       ["a recording of a violin solo"]]
# prompt_for_trained = [["Duet, played with flute"],
#                       ["Duet, played with cello"],
#                       ["Duet, played with violin"],
#                       ["Duet, played with acoustic guitar"]]
# prompt_for_trained = [["played with an orchestra"], ["a sad music"], ["a happy music"], ["an angry music"]]
negative_prompt_for_trained = ["low quality, noise"]
attn_procs = {}
for name in unet.attn_processors.keys():
        ...
        if cross_attention_dim is None:
                ...
                cross_attention_dim = cross[num%8]
                num = num + 1
...
for i in range(len(prompt_for_trained)):
        waveform = pipeline_trained(audio_file = audio_promt_file, audio_file2 = audio_promt_file2, time_pooling = time_pooling , freq_pooling = freq_pooling, prompt = prompt_for_trained[i]*num_files, negative_prompt = negative_prompt_for_trained*num_files, num_inference_steps=50, num_waveforms_per_prompt=1, audio_length_in_s=10).audios
