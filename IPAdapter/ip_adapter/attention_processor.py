...
class IPAttnProcessor2_0(torch.nn.Module):
    ...
    def __init__(self, hidden_size, name, cross_attention_dim=None, num_tokens=4, scale=1.0):
        super().__init__()
        ...
        self.name = name
        # print("do copy")
        # k_weight = torch.load(f'/data/fundwotsai/DreamSound/DreamSound/save_attention_weight/{self.name}_k.bin')
        # v_weight = torch.load(f'/data/fundwotsai/DreamSound/DreamSound/save_attention_weight/{self.name}_v.bin')
